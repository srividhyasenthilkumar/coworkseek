...
export default function ChennaiPage() {
  ...
  const filteredSpaces =
    activeArea === "All"
      ? hyderabadSpaces
      : hyderabadSpaces.filter((space) => space.area === activeArea);

  return (
    <section className="max-w-7xl mx-auto mt-30 px-4 py-6">
      {/* Breadcrumb */}
      <p className="text-sm text-gray-500 mb-4">Home / Coworking / Hyderabad</p>
        ...
        {filteredSpaces.map((space, i) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-500">{space.area}, Hyderabad</p>
